...
namespace Com.Azure.Android.Core.Util.Paging {
	...
	public partial interface IPage : IJavaObject, IJavaPeerable {
		global::Java.Lang.Object? ContinuationToken {
			...
			[Register ("getContinuationToken", "()Ljava/lang/Object;", "GetGetContinuationTokenHandler:Com.Azure.Android.Core.Util.Paging.IPageInvoker, azure_core_binding")]
			get; 
		}
		...
		global::System.Collections.IList? Elements {
			...
			[Register ("getElements", "()Ljava/util/List;", "GetGetElementsHandler:Com.Azure.Android.Core.Util.Paging.IPageInvoker, azure_core_binding")]
			get; 
		}
