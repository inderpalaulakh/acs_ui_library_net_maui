...
namespace Com.Azure.Android.Core.Util.Paging {
	...
	public partial interface IPagedAsyncStreamCore : global::Com.Azure.Android.Core.Util.IAsyncStream {
		...
		[Register ("byPage", "()Lcom/azure/android/core/util/AsyncStream;", "GetByPageHandler:Com.Azure.Android.Core.Util.Paging.IPagedAsyncStreamCoreInvoker, azure_core_binding")]
		...
		[Register ("byPage", "(Ljava/lang/Object;)Lcom/azure/android/core/util/AsyncStream;", "GetByPage_Ljava_lang_Object_Handler:Com.Azure.Android.Core.Util.Paging.IPagedAsyncStreamCoreInvoker, azure_core_binding")]
		...
		[Register ("from", "(Ljava/lang/Object;)Lcom/azure/android/core/util/AsyncStream;", "GetFrom_Ljava_lang_Object_Handler:Com.Azure.Android.Core.Util.Paging.IPagedAsyncStreamCoreInvoker, azure_core_binding")]
		...
		[Register ("getPage", "(Ljava/lang/String;Lcom/azure/android/core/util/BiConsumer;)V", "GetGetPage_Ljava_lang_String_Lcom_azure_android_core_util_BiConsumer_Handler:Com.Azure.Android.Core.Util.Paging.IPagedAsyncStreamCoreInvoker, azure_core_binding")]
